...
每个$\lambda$都是一个权重值，c表示类别，r表示（x, y, w, h）
...
2、如果`GT`与某个`Anchor`模板的`IoU`大于给定的阈值，则将`GT`分配给该`Anchor`模板，如图中的`AT2`
...
![image-20220818110511213](../img/image-20220818110511213.png)
